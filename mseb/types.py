...
class SoundEmbedding:
  ...
  # Optional field for streaming stats when the embedding is generated by a
  # streaming model.
...
class StreamingStats:
  """A dataclass for streaming stats.

  Attributes:
    events: The sequence of events received from the server.
    chunk_duration: The duration of each chunk in seconds.
    wait_duration: The duration to wait between each chunk in seconds.
  """
  events: Sequence[StreamingSpeechToTextEvent]
