...
from mseb.encoders.google import gemma_reasoning_encoder
...
class ReasoningEvaluator(evaluator.Evaluator):
  ...
  def __init__(
      self,
      reasoning_encoder: gemma_reasoning_encoder.GemmaReasoningEncoder,
  ):
    """Initializes the evaluator with the encoder."""
    self._encoder = reasoning_encoder
